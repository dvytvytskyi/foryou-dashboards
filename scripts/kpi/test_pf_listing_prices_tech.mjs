...
async function testPriceWithTechnicalId() {
    const token = await getPFToken();
    // Використовуємо ТЕХНІЧНИЙ ID, який я щойно знайшов у списку
    const testId = '00NTFJQ4A4GSHW0PPJWSAJ81DG'; 
    const url = `https://atlas.propertyfinder.com/v1/listings/${testId}/publish/prices`;
    
    console.log(`Testing price for technical ID ${testId}...`);
