...
const NODES: SystemNode[] = [
  ...
  { id: 'job_pf_listings', type: 'job', title: 'pf_listings_report_auto (manual)', owner: 'PF', freshnessMode: 'manual', refreshFrequency: 'manual', criticality: 'high', status: 'warning', notes: 'Generates pf_listings_report.json', fileRef: 'scripts/pf_listings_report_auto.mjs' },
  { id: 'job_pf_projects', type: 'job', title: 'generate_pf_projects_report (manual)', owner: 'PF', freshnessMode: 'manual', refreshFrequency: 'manual', criticality: 'high', status: 'warning', notes: 'Generates pf_projects_report.json', fileRef: 'scripts/kpi/generate_pf_projects_report.mjs' },
  ...
  { id: 'ext_pf_api', type: 'external', title: 'Property Finder API', owner: 'External', freshnessMode: 'manual', refreshFrequency: 'when script runs', criticality: 'medium', status: 'warning', notes: 'Used only by manual PF scripts', fileRef: 'scripts/pf_listings_report_auto.mjs' },
];
