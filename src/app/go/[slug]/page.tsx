...
export default async function GoBridgePage(props: Props) {
        ...
        await fetch(`https://${domain}/api/v4/leads`, {
            ...
            body: JSON.stringify([{
                ...
                custom_fields_values: [
                    { field_id: 683939, values: [{ value: utm_source }] },
                    { field_id: 683937, values: [{ value: utm_campaign }] },
                    { field_id: 683935, values: [{ value: utm_medium }] },
                    { field_id: 683933, values: [{ value: utm_content }] },
